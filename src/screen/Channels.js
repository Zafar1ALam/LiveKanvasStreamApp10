...
const Channels = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={{
            ...
            <HeaderLeftArrowText text="Channels"
            ...
            <View style={{
                ...
                <TouchableRipple style={{ height: '100%', width: '30%' }}
                >
                    <>
                        <Image source={require('../utilities/images/car.png')}
                            style={{
                                // flex: 1, 
            ...
            <FlatList style={{
                ...
                renderItem={({ item }) => {
                    return (
                        ...
                        }} onPress={() => { navigation.navigate("VedioTitle") }}>
                            <>
                                <View style={{
