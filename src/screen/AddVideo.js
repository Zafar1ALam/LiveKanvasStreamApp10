...
const AddVideo = ({ navigation }) => {
    ...
    const [stateIsValidUploadVideo, setStateIsValidUploadVideo] = useState(true);
    ...
    const uploadVideo = async () => {
        ImagePicker.openPicker({
            ...
            setStataData({
                ...stateData,
                uploadVideo: vedio.path
            })
            setStateIsValidUploadVideo(true)
            // if (image != null) {
    ...
    const post = () => {
        ...
        if (stateData.uploadVideo == '') {
            //   console.log(stateData.email + 'emailaddress')
            setStateIsValidUploadVideo(false)
        ...
        <SafeAreaView
            ...
            <Appbar.Header style={{
                ...
                <Appbar.BackAction
                    onPress={() =>
                        navigation.goBack()} />
                <Appbar.Content title="ADD VIDEO"
                    titleStyle={{
                        alignSelf: 'center',
                        marginLeft: "-7%"
            ...
            <ScrollView>
                        ...
                        {stateData.uploadVideo == '' ?
                            <TouchableRipple style={{
                                ...
                                <>
                                    ...
                                    <Text style={STYLES.fontSize12_whiteFFFFFF_MADE_TOMMY_Regular_PERSONAL_USE_Regular}>Upload Vedio</Text>
                                </>
                            </TouchableRipple>
                            :
                            <TouchableRipple style={{
                                ...
                                <>
                                    <SvgXml xml={Svgs.uploadSvg} style={{ marginRight: "5%" }} />
                                    <Text style={STYLES.fontSize12_whiteFFFFFF_MADE_TOMMY_Regular_PERSONAL_USE_Regular}>Uploaded Vedio</Text>
                                </>
                            </TouchableRipple>
                        }
                    </View>
                ...
                <View style={{ flexDirection: 'row', marginHorizontal: '5%', }}>
                    <View style={{ width: '55%' }}>
                        {stateIsValidUploadVideo == false ? <Text style={{ color: 'red' }}>Upload Video</Text> : null}
                    </View>
